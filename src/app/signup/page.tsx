    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-6">
          <h1 className="text-2xl font-bold mb-2">Join FinAI</h1>
          <p className="text-muted-foreground">
            Create your account to start analyzing your finances
          </p>
        </div>
        ...
        {!clerkKey ? (
          <div className="text-center p-8 border border-border rounded-lg bg-card">
            ...
            <p className="text-muted-foreground mb-4">
              Please configure Clerk authentication to use the signup feature.
            </p>
